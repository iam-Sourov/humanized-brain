...
import { Geist, Geist_Mono, EB_Garamond, Roboto_Mono } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${garamond.variable} ${robotoMono.variable} antialiased brutalist-body`}
